...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('material/add_process/');?>";
	var sites_edit = "<?php echo site_url('material/update_process/');?>";
	var sites_del  = "<?php echo site_url('material/delete/');?>";
	var sites_get  = "<?php echo site_url('material/update/');?>";
    var sites_ledger  = "<?php echo site_url('material/ledger/');?>";
    var sites_primary  = "<?php echo site_url('material/publish/');?>";
	var sites_attribute  = "<?php echo site_url('material/attribute/');?>";
	var sites_image  = "<?php echo site_url('material/image_gallery/');?>";
          ...
          <div class="row"> 
           ...
           <form id="searchform" class="form-inline">
              ...
              <div class="form-group">
                 ...
                 <?php $js = "class='select2_single form-control' id='cmaterial' tabindex='-1' style='min-width:200px;' "; 
			     echo form_dropdown('cmaterial', $material, isset($default['material']) ? $default['material'] : '', $js); ?>
              </div>
               
               <div class="form-group">
                 <label> Color : </label> <br>
                 <?php $js = "class='select2_single form-control' id='ccolor' tabindex='-1' style='min-width:150px;' "; 
...
<!--               <a class="btn btn-primary" href="<?php //echo site_url('product/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New </a>-->
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('material_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Attribute -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <?php $this->load->view('material_update'); ?> 
      </div>
      <!-- Modal Attribute -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('material_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
