...
class Shiprate extends MX_Controller
{
    ...
    private $properti, $modul, $title, $city, $shiprate;
	...
	{
	   $output[] = array ($res->id, $res->courier, $this->city->get_name($res->dest_id), strtolower($res->type), idr_format($res->rate));
	}
            $this->output
	...
	// ---------------------------------------- //
        ...
        $this->table->set_heading('#','No', 'Courrier', 'Type', 'Destination', 'Rate', 'Action');
